    ...
    <>
      ...
      <div className=" w-full px-[20px] md:px-[clamp(20px,12vw,122px)]  ">
        <div className="max-w-[1084px] mx-auto ">
          ...
          <div className="w-full xs:my-8 xsm:my-11 md:my-20 lg:my-32">
            <h2 className="h2-text xs:mb-8 md:mb-14">A path for everyone</h2>
            <div className="w-full flex items-center justify-between md:justify-normal gap-5  flex-wrap">
              <CourseCard
                Icon
